...
func TestGetConfig(t *testing.T) {
	...
	expected.EmailConf.HTMLModel = "product_url:https://github.com/tinkerbaj/gintemp;product_name:gintemp;company_name:pilinux;company_address:Country"
	...
	expected.Security.JWT.Issuer = "gintemp"
	...
	expected.Security.TwoFA.Issuer = "gintemp"

...
// ValidateUserID - check whether userID is missing
// func ValidateUserID(userID uint) bool {
// 	return userID != 0
// }

// ValidateUserID - check whether userID or email is missing
func ValidateUserID(userID uint64, email string) bool {
...
func DelMem2FA(userID uint) {
	delete(model.InMemorySecret2FA, userID)
}
